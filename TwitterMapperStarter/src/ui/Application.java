    ...
    public Application() {
        ...
        map().addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                map().setToolTipText(twtDisplay(pos,p));
            }
        });
    }

    private String twtDisplay(ICoordinate pos, Point p){
        ...
        for(MapMarker m: markers){
            if (m instanceof MapMarkerImage){
                ...
                twt = "<html><img src=" + marker.getUser().getProfileImageURL()
                        + "><p>" + marker.getStatus().getText() + "</p></html>";
            }
        }
        return twt;
    }
